import { DayNumber, ERROR_MESSAGE, PartNumber } from './common';
...
// for (let i = 1; i < 26; i++) {
//   cpSync(path.join(__dirname, 'days/dayTemplate.ts'), path.join(__dirname, `days/day${i}.ts`));
//   const indexString = String(i).padStart(2, '0');
//   cpSync(path.join(__dirname, 'inputs/day-input.txt'), path.join(__dirname, `inputs/day-${indexString}.txt`));
//   cpSync(path.join(__dirname, 'inputs/day-input.txt'), path.join(__dirname, `inputs/day-${indexString}-example-1.txt`));
//   cpSync(path.join(__dirname, 'inputs/day-input.txt'), path.join(__dirname, `inputs/day-${indexString}-example-2.txt`));
// }
